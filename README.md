...
This project is configured for the repository name `Nitish-Online-Portfolio` in [vite.config.ts](/c:/PROJECTS/onlineresume/vite.config.ts). If the repository name changes, update the `base` value before deploying.
